...
// #cgo linux,amd64 LDFLAGS: -L${SRCDIR}/lib/build/linux_x64 -ldave
//
// #cgo darwin,amd64 LDFLAGS: -L${SRCDIR}/lib/build/macos_x64 -ldave
// #cgo darwin,arm64 LDFLAGS: -L${SRCDIR}/lib/build/macos_arm64 -ldave
//
