...
[![DisGo Version](https://img.shields.io/github/v/tag/disgoorg/godave?label=release)](https://github.com/disgoorg/godave/releases/latest)
...
GoDave is a library that provides Go bindings for [libdave](https://github.com/discord/libdave) and facilitates using
them with [DisGo](github.com/disgoorg/disgo)
